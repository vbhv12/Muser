...
export default function StreamView({
  ...
  async function refreshStreams() {
    ...
    const activeVideo = res.data.activeStream?.stream;
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {playVideo && <div className="flex space-x-2">
          <Input
            type="text"
        ...
        {playVideo && <div className='grid justify-items-end'>
        ...
        <div className="space-y-4">
          ...
          {queue.length == 0 &&  <p className="font-bold">No Upcoming Videos Playing</p>}
